...
<Mermaid
  chart={`graph LR
    ...
    style B fill:#818cf8,stroke:#4f46e5,color:#f8fafc`}
/>
...
<Mermaid
  chart={`graph LR
    B[Your Browser]-->|Types website name|S[Web Server]
    S-->|Sends back webpage|B
...
<Mermaid
  chart={`sequenceDiagram
    ...
    B->>S: 1. You type website address
    S-->>B: 2. Server sends HTML page 
    B->>S: 3. Browser asks for images & styles
    S-->>B: 4. Server sends those files
    Note over B: 5. Your page appears!`}
/>
