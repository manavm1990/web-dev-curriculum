...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        'bg-background/55 fixed top-2 z-10 h-11 w-11 rounded-md shadow-xs backdrop-blur-sm transition-transform',
        open ? 'rotate-180' : '',
        className,
      )}
      onClick={(event) => {
      ...
      {...props}
    >
      <PanelLeftOpen className={`stroke-foreground stroke-2`} />
