...
- **VS Code** is like your workbench, where you'll write and edit your code.
- **Terminal** is like your tool belt, letting you run commands and manage files.
- **Git** is like your camera, taking snapshots of your work as you build.
- **GitHub** is like your backup drive, keeping your work safe and shareable.
- `npm` is like your hardware store - where you get pre-built parts to use.
...
<figure className="my-4 flex justify-center">
  <div>
    <Image
      src="https://file.notion.so/f/f/f260517f-b741-4b93-b79a-5aebc1ddfab7/cfc55036-be58-4da2-99d4-9a4c3cfd21c6/Untitled.png?table=block&id=2e522f34-836d-4d97-809a-b42bd8fd270d&spaceId=f260517f-b741-4b93-b79a-5aebc1ddfab7&expirationTimestamp=1737007200000&signature=8VBNc8IvhseFwukSOIMYBjwam5iKVv50Cuvsw7WHj8g&downloadName=Untitled.png"
...
<Image src={macHome} alt="Home directory on a Mac" />
