...
- <Large className="my-0">VS Code</Large> is like your workbench, where you'll write and edit your
  code.
- <Large className="my-0">Terminal</Large> is like your tool belt, letting you run commands and
  manage files.{' '}
- <Large className="my-0">Git</Large> is like your camera, taking snapshots of your work as you
  build.{' '}
- <Large className="my-0">GitHub</Large> is like your backup drive, keeping your work safe and
  shareable. - `npm` is like your hardware store - where you get pre-built parts to use.
