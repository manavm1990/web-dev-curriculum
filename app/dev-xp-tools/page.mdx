...
<Mermaid chart={`
graph LR
    subgraph "VS Code (Your Workshop)"
        A[Write Code] -->|Save file| B[Edit Code]
        B -->|Debug| A
    end

    subgraph "Git (Version Control)"
        C[git add] -->|Stage changes| D[git commit]
        D -->|Save snapshot| E[git push]
        E -->|Upload to GitHub| F[Remote Repository]
    end

    B -->|Ready to save milestone| C

    classDef default fill:#f8fafc,stroke:#6366f1,color:#000
    classDef vscode fill:#1e1e1e,color:#f8fafc,stroke:#6366f1,stroke-width:2px
    classDef git fill:#c7d2fe,stroke:#4f46e5,color:#000,stroke-width:2px
...
<section className="flex justify-between">
  <Bq
    quote="When I was a child, I used a computer by looking at the pictures. When I grew up, I learned to read and write."
...
<Image
  src="https://d8n3.c1.e2-8.dev/swic/terminal-prompt.png"
...
## Common Tool Confusions

Many new developers wonder about the relationships between our different tools. Here's a quick breakdown:

- VS Code is your workspace - where you actually write and edit code
- Git is your history keeper - saves different versions of your code
- GitHub is your cloud storage - where your Git history lives online
- Terminal is your command center - how you tell Git what to do
