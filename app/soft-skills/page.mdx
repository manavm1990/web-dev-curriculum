...
<Image src="https://d8n3.c1.e2-8.dev/swic/mdn.png" alt="MDN AI Tool" width={350} height={368} />
...
**Reflection on Soft Skills Lesson (20 points)**

- Write a short reflection (200-300 words) on the soft skills lesson.
...
Send me a direct message on Teams to ensure that we can communicate there (5 points).

Create an account on GitHub using your SWIC student email. This will give you access to GitHub Pro and Copilot Pro for free. For more information, see [GitHub Education](https://education.github.com/). Send me a direct message on Teams with your GitHub username (5 points).
