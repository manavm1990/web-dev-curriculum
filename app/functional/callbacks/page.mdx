...
You should have your template repo cloned and ready to go. So, work through this whole lesson from top to bottom. As you finish each section, make sure to add and commit your changes.
